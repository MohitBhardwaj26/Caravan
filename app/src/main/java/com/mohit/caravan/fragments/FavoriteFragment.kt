...
import com.mohit.caravan.adapters.FavoriteAdapter
import com.mohit.caravan.currentSongHelper
import com.mohit.caravan.databases.caravanDatabase
import com.mohit.caravan.fragments.FavoriteFragment.Statified.meediaPlayer
...
class FavoriteFragment : Fragment() {
    ...
    var favouriteDatabase: caravanDatabase? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        favouriteDatabase = caravanDatabase(activity)
    ...
    fun display_favorites_by_searching() {
        if (favouriteDatabase?.checkSize() as Int > 0) {
            ...
            _getSongs = (favouriteDatabase as caravanDatabase).queryDBList()
